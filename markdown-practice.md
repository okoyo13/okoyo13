...
2. Run `git add .`to add files, basically to add everything.
...
- [x] Installing VS Code.
- [ ] Build my first portfolio website.
- [ ] Complete a JavaScript course.

### Code Blocks
```python
print("I am fascinated with Web Development!")
```
